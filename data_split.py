...
out_root_path = r"E:\multi-modal\ei"
...
def split_dataset(root_path, train_ratio=0.75, random_seed=42):
    ...
    original_paths = {
        ...
        'depth': os.path.join(root_path, 'depth'),
...
def main():
    # 设置路径
    root_path = r"E:\multi-modal\full\train"

    # 执行划分
    # 可以调整训练集比例，例如0.75表示75%训练，25%测试
    split_dataset(root_path, train_ratio=0.75, random_seed=42)
