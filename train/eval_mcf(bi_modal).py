...
config_yaml = 'yolo11n_mcf(m3data)'
weights_dir = 'E:/MCF-Net/runs/detect/yolo11n_mcf(m3data)'
device = '1'
lmc_multi_modal_m3data = True

if __name__ == '__main__':
    model = YOLO(weights_dir + '/weights/best.pt')
    metrics = model.val(
        data='ei-multimodal(m3data).yaml',
        imgsz=640,
        device=device,
        batch=32,
    ...
    print(f"✅ {config_yaml}_eval_results.csv")
    print(
