...
class BaseValidator:
    ...
    def __call__(self, trainer=None, model=None):
        ...
        if self.training:
            ...
            self.dataloader = (self.dataloader or
                               self.get_dataloader(self.data.get(self.args.split), self.args.batch,
                                                   self.args.lmc_multi_modal, self.args.lmc_multi_modal_m3data))
    ...
    def get_dataloader(self, dataset_path, batch_size, lmc_multi_modal = False,
