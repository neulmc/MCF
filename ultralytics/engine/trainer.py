...
class BaseTrainer:
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks: dict | None = None):
        ...
        self.metrics = None
        self.plots = {}
        self.lmc_multi_modal = self.args.lmc_multi_modal
        self.lmc_multi_modal_m3data = self.args.lmc_multi_modal_m3data
    ...
    def _build_train_pipeline(self):
        ...
        self.train_loader = self.get_dataloader(
            ...
            lmc_multi_modal = self.lmc_multi_modal, lmc_multi_modal_m3data = self.lmc_multi_modal_m3data
        )
        ...
        self.test_loader = self.get_dataloader(
            ...
            rank=LOCAL_RANK,
            mode="val",
            lmc_multi_modal = self.lmc_multi_modal,
            lmc_multi_modal_m3data = self.lmc_multi_modal_m3data,
        )
        ...
        while True:
            ...
            for i, batch in pbar:
                ...
                if ni - last_opt_step >= self.accumulate:
                    '''
                    ss7 = self.model.model[6].m[0].cv1.conv.weight
                    s2 = self.model.model[17]
                    s3 = s2.m
                    s4 = s2.m[0]
                    s5 = s2.m[0].cv1
                    s6 = s2.m[0].cv1.conv
                    s7 = s2.m[0].cv1.conv.weight
                    '''
                    self.optimizer_step()
                    last_opt_step = ni
