...
def build_yolo_dataset(
    ...
    lmc_multi_modal : bool = False,
    lmc_multi_modal_m3data : bool = False,
) -> Dataset:
    ...
    elif lmc_multi_modal:
        dataset = MultiModalYOLODataset
    elif lmc_multi_modal_m3data:
        dataset = MultiModalYOLODataset_m3data
    elif multi_modal:
...
def load_inference_source(
    ...
    if tensor:
        ...
        dataset = LoadImagesAndVideos(source, batch=batch, vid_stride=vid_stride, channels=channels, modal = modal)
